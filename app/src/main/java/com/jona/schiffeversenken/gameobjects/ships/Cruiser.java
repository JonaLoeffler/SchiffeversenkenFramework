...
public class Cruiser extends Ship {
    ...
    public Cruiser(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Cruiser(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setImage() {
        setImageResource(R.drawable.ship_cruiser);
    }
}
